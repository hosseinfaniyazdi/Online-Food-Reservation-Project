...
namespace cmsyasix.web.Pages.Admin.Discount
{
    ...
    public class CreateDiscountModel : PageModel
    {
        ...
        [BindProperty]
        public Data.Entities.Order.Discount Discount { get; set; }
        public void OnGet()
        {
        ...
        public IActionResult OnPost(string stDate = "", string edDate = "")
        {
            ...
            if (!ModelState.IsValid && _orderService.ExistCode(Discount.DiscountCode))
                return Page();
        ...
        public IActionResult OnGetCheckExistCode(string code)
        {
            return Content(_orderService.ExistCode(code).ToString());
        }
    }
}
